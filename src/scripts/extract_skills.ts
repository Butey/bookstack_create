...
const allSkills = [
  ...
  { id: 'context-degradation', name: 'Context Degradation', badge: 'Новое', icon: 'Brain', desc: 'Защита от деградации контекста LLM при длинных сессиях.' },
  { id: 'docs-architect', name: 'Docs Architect', badge: 'Новое', icon: 'FileSpreadsheet', desc: 'Выстраивание строгой информационной архитектуры в документации.' },
  { id: 'multi-agent-patterns', name: 'Multi-Agent Patterns', badge: 'Новое', icon: 'Cpu', desc: 'Применение паттернов кооперации нескольких LLM-агентов.' },
  { id: 'parallel-agents', name: 'Parallel Agents', badge: 'Новое', icon: 'Layers', desc: 'Управление параллельным исполнением агентов.' },
  { id: 'chat-widget', name: 'Chat Widget', badge: 'Новое', icon: 'Terminal', desc: 'Генерация спецификации встраиваемого виджета чата.' },
  { id: 'ai-agent-development', name: 'AI Gen. Agent', badge: 'Новое', icon: 'Sparkles', desc: 'Паттерны проектирования автономных AI агентов.' },
  { id: 'database', name: 'Database', badge: 'Новое', icon: 'Database', desc: 'Базовые практики проектирования хранилищ данных.' },
  { id: 'data-structure-protocol', name: 'Data Protocol', badge: 'Новое', icon: 'RefreshCw', desc: 'Обеспечение соблюдения выбранного протокола струтур.' },
  { id: 'database-architect', name: 'DB Architect', badge: 'Новое', icon: 'Network', desc: 'Глубокое архитектурное проектирование баз данных.' },
  { id: 'documentation-generation-doc-generate', name: 'Doc Gen', badge: 'Новое', icon: 'FileText', desc: 'Автоматическая генерация документации на лету.' },
  { id: 'langchain-architecture', name: 'LangChain Arch', badge: 'Новое', icon: 'Link', desc: 'Архитектурные принципы популярного фреймворка LangChain.' },
  { id: 'llm-application-dev-langchain-agent', name: 'LangChain Agent', badge: 'Новое', icon: 'Box', desc: 'Разработка агента на базе экосистемы LangChain.' },
  { id: 'llm-application-dev-ai-assistant', name: 'AI Assistant Core', badge: 'Новое', icon: 'Cpu', desc: 'Разработка ядра интеллектуального ассистента.' },
  { id: 'llm-application-dev-prompt-optimize', name: 'Prompt Optimize', badge: 'Новое', icon: 'Settings', desc: 'Оптимизация и тонкая настройка промптов.' },
  { id: 'llm-ops', name: 'LLM Ops', badge: 'Новое', icon: 'Activity', desc: 'Применение практик MLOps в управлении LLM приложениями.' },
  { id: 'not-human-search-mcp', name: 'Machine Search', badge: 'Новое', icon: 'Search', desc: 'Интеграция Machine-to-Machine поисковых протоколов.' },
  { id: 'prompt-engineering-patterns', name: 'Prompt Patterns', badge: 'Новое', icon: 'PenTool', desc: 'Высокоуровневые паттерны промпт инжиниринга.' },
  { id: 'rag-engineer', name: 'RAG Engineer', badge: 'Новое', icon: 'Layers', desc: 'Интеграция лучших практик Retrieval-Augmented Generation.' },
  { id: 'rag-implementation', name: 'RAG Implementation', badge: 'Новое', icon: 'Layers', desc: 'Глубокое внедрение алгоритмов RAG.' },
  { id: 'similarity-search-patterns', name: 'Similarity Search', badge: 'Новое', icon: 'Search', desc: 'Паттерны векторного (Similarity) поиска в базах данных.' },
  { id: 'vector-index-tuning', name: 'Vector Tuning', badge: 'Новое', icon: 'Settings', desc: 'Оптимизация параметров векторных индексов.' },
  { id: 'yes-md', name: 'Yes Markdown', badge: 'Новое', icon: 'FileSpreadsheet', desc: 'Форсированное и исключительно чистое MD-форматирование.' },
  { id: 'mcp-builder-ms', name: 'MCP Microservices', badge: 'Новое', icon: 'Cpu', desc: 'Проектирование микросервисной архитектуры на протоколе MCP.' },
  { id: 'nodejs-backend-patterns', name: 'Node.js Backend', badge: 'Новое', icon: 'Terminal', desc: 'Интеграция паттернов разработки бэкенда на Node.js.' },
  { id: 'professional-proofreader', name: 'Professional Proofreader', badge: 'Новое', icon: 'CheckCircle', desc: 'Профессиональная вычитка и корректура текстов уровня издательства.' },
  { id: 'wiki-architect', name: 'Wiki Architect', badge: 'Новое', icon: 'Network', desc: 'Глубокое архитектурное проектирование структуры Wiki (разделы, связи).' },
  { id: 'make-automation', name: 'Make.com Automation', badge: 'Новое', icon: 'Cpu', desc: 'Спецификация интеграций и сценариев для Make.com.' }
];
